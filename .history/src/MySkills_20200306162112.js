    ...
    return(
        <div id="my_skils_bg">
            ...
            <div id="my_skils">
                ...
                <div><img src="<?php bloginfo('template_directory'); ?>/img/wordpress.png"/><p>WordPress</p></div>
                <div><img src="<?php bloginfo('template_directory'); ?>/img/laravel.png"/><p>Laravel</p></div>
                <div><img src="<?php bloginfo('template_directory'); ?>/img/yii.png"/><p>Yii</p></div>
                <div><img src="<?php bloginfo('template_directory'); ?>/img/php.png"/><p>PHP</p></div>
